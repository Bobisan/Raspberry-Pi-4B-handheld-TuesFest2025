...
IO.setup(17,IO.OUT)            # Initialize GPIO14 as our fan output pin
fan = IO.PWM(17,100)           # Set GPIO14 as a PWM output, with 100Hz frequency (this should match your fans specified PWM frequency)
...
while 1:                                    # Execute loop forever
    ...
    time.sleep(5)                           # Sleep for 5 seconds# Created by: Michael Klements
# For 40mm 5V PWM Fan Control On A Raspberry Pi
# Sets fan speed proportional to CPU temperature - best for good quality fans
# Works well with a Pi Desktop Case with OLED Stats Display
